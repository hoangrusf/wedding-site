...
<body>
  ...
  <main id="main-content" class="main-content hidden">
    ...
    <!-- HERO SECTION -->
    <section id="hero" class="hero-section" <?php if($config->hero_image_url): ?> style="background-image: url('<?php echo e($config->hero_image_url); ?>')" <?php endif; ?>>
      ...
      <div class="event-timeline" data-aos="fade-up" data-aos-delay="200">
        <div class="timeline-item">
          ...
          <div class="timeline-content">
            <h4>Đón Khách</h4>
            <p class="timeline-time"><?php echo e($config->wedding_date->copy()->subMinutes(30)->format('H:i')); ?></p>
          </div>
        </div>
        <div class="timeline-item">
          <div class="timeline-icon">
          ...
          <div class="timeline-content">
            <h4>Làm Lễ</h4>
            <p class="timeline-time"><?php echo e($config->wedding_date->format('H:i')); ?></p>
          </div>
        </div>
        <div class="timeline-item">
          <div class="timeline-icon">
          ...
          <div class="timeline-content">
            <h4>Khai Tiệc</h4>
            <p class="timeline-time"><?php echo e($config->wedding_date->copy()->addHour()->format('H:i')); ?></p>
          </div>
        </div>
      </div>
    ...
    <footer class="footer" data-aos="fade-up">
      ...
      <p class="footer-names"><?php echo e($config->groom_name); ?> ♡ <?php echo e($config->bride_name); ?></p>
      ...
      <p class="footer-thanks">Sự hiện diện của bạn là niềm vinh hạnh của chúng tôi!</p>
    </footer>
  </main>
  ...
  <audio id="bg-music" loop preload="auto">
    <source src="<?php echo e($config->background_music_url ?? 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3'); ?>" type="audio/mpeg" />
  </audio>
...
<?php /**PATH C:\xampp\htdocs\InviteMarried\resources\views/wedding.blade.php ENDPATH**/ ?>