        ...
        <div id="wishes-list" class="wishes-list">
          ...
          <div class="wish-card">
            <div class="wish-header">
              ...
              <p class="wish-date"><?php echo e($wish->created_at->format('d/m/Y H:i')); ?></p>
            </div>
      ...
      <div class="gift-grid" id="gift-grid" style="display: none;">
        ...
        <div class="gift-card" data-aos="fade-right" data-aos-delay="200">
          <div class="gift-avatar">
            <?php if(!empty($brideImageUrl)): ?>
              <img src="<?php echo e($brideImageUrl); ?>" alt="<?php echo e($config->bride_name); ?>" style="width:250px;height:250px;border-radius:50%;object-fit:cover;object-position:<?php echo e($brideImagePos); ?>;" />
            <?php else: ?>
          ...
          <h3>Cô Dâu - <?php echo e($config->bride_name); ?></h3>
          <div class="gift-qr">
        ...
        <div class="gift-card" data-aos="fade-left" data-aos-delay="200">
          <div class="gift-avatar">
            <?php if(!empty($groomImageUrl)): ?>
              <img src="<?php echo e($groomImageUrl); ?>" alt="<?php echo e($config->groom_name); ?>" style="width:250px;height:250px;border-radius:50%;object-fit:cover;object-position:<?php echo e($groomImagePos); ?>;" />
            <?php else: ?>
          ...
          <h3>Chú Rể - <?php echo e($config->groom_name); ?></h3>
          <div class="gift-qr">
          ...
          <div class="gift-bank-info">
            <p class="gift-bank"><?php echo e($bankInfo['groom']['bank_name']); ?></p>
            <p class="gift-holder"><?php echo e($bankInfo['groom']['account_name']); ?></p>
            <p class="gift-account">
              STK: <span id="groom-stk-type2"><?php echo e($bankInfo['groom']['account_no']); ?></span>
            </p>
        ...
        <div class="gift-card" data-aos="fade-right" data-aos-delay="200">
          ...
          <div class="gift-bank-info">
            ...
            <p class="gift-holder"><?php echo e($bankInfo['groom']['account_name']); ?></p>
            <p class="gift-account">
              STK: <span id="groom-stk"><?php echo e($bankInfo['groom']['account_no']); ?></span>
            </p>
        ...
        <div class="gift-card" data-aos="fade-left" data-aos-delay="200"> 
          ...
          <div class="gift-bank-info">
            <p class="gift-bank"><?php echo e($bankInfo['bride']['bank_name']); ?></p>
            <p class="gift-holder"><?php echo e($bankInfo['bride']['account_name']); ?></p>
            <p class="gift-account">
              STK: <span id="bride-stk-type1"><?php echo e($bankInfo['bride']['account_no']); ?></span>
            </p>
...
<p class="footer-thanks">© Designed and developed by Nguyễn Công Hoàng</p>
  ...
  <script>
    window.weddingData = {
      <?php if($type == 2 && $config->bride_wedding_date): ?>
      weddingDate: '<?php echo e($config->bride_wedding_date->toIso8601String()); ?>',
      <?php else: ?>
      ...
      wishesUrl: '<?php echo e(route('wishes.store')); ?>',
