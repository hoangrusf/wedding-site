...
<div class="content">
<form method="POST" action="<?php echo e(route('admin.config.update')); ?>">
  <?php echo csrf_field(); ?>
    ...
    <div class="section-body">
      <div class="form-grid">
        <div class="form-group">
          ...
          <input type="text" name="groom_name" value="<?php echo e(old('groom_name', $config->groom_name)); ?>" required maxlength="100" class="<?php echo e($errors->has('groom_name') ? 'input-error' : ''); ?>" />
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          ...
          <input type="text" name="bride_name" value="<?php echo e(old('bride_name', $config->bride_name)); ?>" required maxlength="100" class="<?php echo e($errors->has('bride_name') ? 'input-error' : ''); ?>" />
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          ...
          <input type="hidden" name="hero_image_scale" id="scale-hero" value="<?php echo e(old('hero_image_scale', $config->hero_image_scale ?? 1)); ?>" />
          <div class="img-preview-wrapper">
            <div class="img-preview-box" id="preview-hero" data-position-input="pos-hero" data-scale-input="scale-hero"></div>
            <div class="img-position-label" id="pos-label-hero">Vị trí: <?php echo e(old('hero_image_position', $config->hero_image_position ?? 'center center')); ?> | Zoom: <?php echo e(old('hero_image_scale', $config->hero_image_scale ?? 1)); ?>x</div>
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="hidden" name="groom_image_scale" id="scale-groom" value="<?php echo e(old('groom_image_scale', $config->groom_image_scale ?? 1)); ?>" />
          <div class="img-preview-wrapper">
            <div class="img-preview-box" id="preview-groom" data-position-input="pos-groom" data-scale-input="scale-groom"></div>
            <div class="img-position-label" id="pos-label-groom">Vị trí: <?php echo e(old('groom_image_position', $config->groom_image_position ?? 'center center')); ?> | Zoom: <?php echo e(old('groom_image_scale', $config->groom_image_scale ?? 1)); ?>x</div>
          </div>
        </div>
        <div class="form-group">
          ...
          <input type="hidden" name="bride_image_scale" id="scale-bride" value="<?php echo e(old('bride_image_scale', $config->bride_image_scale ?? 1)); ?>" />
          <div class="img-preview-wrapper">
            <div class="img-preview-box" id="preview-bride" data-position-input="pos-bride" data-scale-input="scale-bride"></div>
            <div class="img-position-label" id="pos-label-bride">Vị trí: <?php echo e(old('bride_image_position', $config->bride_image_position ?? 'center center')); ?> | Zoom: <?php echo e(old('bride_image_scale', $config->bride_image_scale ?? 1)); ?>x</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="section-body">
      <div class="form-grid">
        <div class="form-group full">
          ...
          <input type="text" name="groom_parents" value="<?php echo e(old('groom_parents', $config->groom_parents)); ?>" placeholder="Ông Nguyễn Văn A & Bà Trần Thị B" />
        </div>
        <div class="form-group full">
          <label>Bố mẹ nhà gái <span class="field-hint">dùng " &amp; " để phân cách Ông và Bà</span></label>
          <input type="text" name="bride_parents" value="<?php echo e(old('bride_parents', $config->bride_parents)); ?>" placeholder="Ông Lê Văn C & Bà Phạm Thị D" />
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="section-body">
      <div class="form-grid">
        ...
        <div class="form-group">
          ...
          <input type="text" name="groom_event_location" value="<?php echo e(old('groom_event_location', $config->groom_event_location)); ?>" placeholder="Trung Tâm Tiệc Cưới White Palace" />
        </div>
        <div class="form-group">
          <label>Địa chỉ</label>
          <input type="text" name="groom_event_address" value="<?php echo e(old('groom_event_address', $config->groom_event_address)); ?>" placeholder="194 Hoàng Văn Thụ, Q.Phú Nhuận" />
        </div>
        <div class="form-group full">
          <label>Link Google Maps trực tiếp <span class="field-hint">URL share từ Google Maps</span></label>
          <input type="text" name="groom_map_url" value="<?php echo e(old('groom_map_url', $config->groom_map_url)); ?>" placeholder="https://maps.app.goo.gl/..." />
        </div>
        <div class="form-group full">
          <label>Google Maps iframe src <span class="field-hint">chỉ lấy phần URL trong src="..."</span></label>
          <textarea name="groom_map_iframe_url" placeholder="https://www.google.com/maps/embed?pb=..."><?php echo e(old('groom_map_iframe_url', $config->groom_map_iframe_url)); ?></textarea>
        </div>
        ...
        <div class="form-group">
          <label>Tên địa điểm</label>
          <input type="text" name="bride_event_location" value="<?php echo e(old('bride_event_location', $config->bride_event_location)); ?>" placeholder="Nhà Hàng Tiệc Cưới..." />
        </div>
        <div class="form-group">
          <label>Địa chỉ</label>
          <input type="text" name="bride_event_address" value="<?php echo e(old('bride_event_address', $config->bride_event_address)); ?>" placeholder="Số X, đường Y, quận Z" />
        </div>
        <div class="form-group full">
          <label>Link Google Maps trực tiếp <span class="field-hint">URL share từ Google Maps</span></label>
          <input type="text" name="bride_map_url" value="<?php echo e(old('bride_map_url', $config->bride_map_url)); ?>" placeholder="https://maps.app.goo.gl/..." />
        </div>
        <div class="form-group full">
          <label>Google Maps iframe src</label>
          <textarea name="bride_map_iframe_url" placeholder="https://www.google.com/maps/embed?pb=..."><?php echo e(old('bride_map_iframe_url', $config->bride_map_iframe_url)); ?></textarea>
        </div>
    ...
    <div class="section-body">
      <div class="form-grid">
        ...
        <div class="form-group">
          ...
          <input type="text" name="groom_bank_name" value="<?php echo e(old('groom_bank_name', $bankInfo['groom']['bank_name'] ?? '')); ?>" placeholder="Vietcombank" />
        </div>
        <div class="form-group">
          <label>Số tài khoản</label>
          <input type="text" name="groom_account_no" value="<?php echo e(old('groom_account_no', $bankInfo['groom']['account_no'] ?? '')); ?>" placeholder="1234567890" />
        </div>
        <div class="form-group full">
          <label>Tên chủ tài khoản</label>
          <input type="text" name="groom_account_name" value="<?php echo e(old('groom_account_name', $bankInfo['groom']['account_name'] ?? '')); ?>" placeholder="NGUYEN VAN A" />
        </div>
        <div class="form-group full">
          ...
          <input type="text" name="groom_qr_url" value="<?php echo e(old('groom_qr_url', $bankInfo['groom']['qr_url'] ?? '')); ?>" placeholder="qr_chure.jpg hoặc https://..." />
        </div>
        ...
        <div class="form-group">
          <label>Tên ngân hàng</label>
          <input type="text" name="bride_bank_name" value="<?php echo e(old('bride_bank_name', $bankInfo['bride']['bank_name'] ?? '')); ?>" placeholder="MB Bank" />
        </div>
        <div class="form-group">
          <label>Số tài khoản</label>
          <input type="text" name="bride_account_no" value="<?php echo e(old('bride_account_no', $bankInfo['bride']['account_no'] ?? '')); ?>" placeholder="0987654321" />
        </div>
        <div class="form-group full">
          <label>Tên chủ tài khoản</label>
          <input type="text" name="bride_account_name" value="<?php echo e(old('bride_account_name', $bankInfo['bride']['account_name'] ?? '')); ?>" placeholder="TRAN THI B" />
        </div>
        <div class="form-group full">
          ...
          <input type="text" name="bride_qr_url" value="<?php echo e(old('bride_qr_url', $bankInfo['bride']['qr_url'] ?? '')); ?>" placeholder="qr_codau.jpg hoặc https://..." />
        </div>
...
<?php /**PATH C:\Users\thispc\Documents\wedding-site\resources\views/admin/config.blade.php ENDPATH**/ ?>