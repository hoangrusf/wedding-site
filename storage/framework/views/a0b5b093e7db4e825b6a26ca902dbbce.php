...
<header class="admin-header">
  ...
  <div class="header-actions" style="display:flex;gap:0.6rem;align-items:center;flex-wrap:wrap;">
    <a href="<?php echo e(route('admin.link')); ?>" style="padding:0.4rem 1rem;background:rgba(255,255,255,0.15);color:#fff;border:1px solid rgba(255,255,255,0.3);border-radius:6px;font-size:0.82rem;text-decoration:none;">🔗 Tạo link thiệp</a>
    ...
    <a href="<?php echo e(route('admin.visits')); ?>" style="padding:0.4rem 1rem;background:rgba(255,255,255,0.15);color:#fff;border:1px solid rgba(255,255,255,0.3);border-radius:6px;font-size:0.82rem;text-decoration:none;">👁️ Lượt xem thiệp</a>
...
<div style="margin:1rem 1.5rem 0;padding:0.75rem 1.1rem;border-radius:8px;background:#ffebee;color:#c62828;border:1px solid #ffcdd2;font-size:0.88rem;">✗ <?php echo e(session('error')); ?></div>
<?php endif; ?>
...
<div class="stats-bar">
  ...
  <div class="stat-card" style="background:#e3f0fb;">
    <div class="stat-number" style="color:#1565c0;"><?php echo e($totalGroomAttending); ?></div>
    <div class="stat-label">Nhà Trai tham dự</div>
  </div>
  <div class="stat-card" style="background:#fce4ec;">
    <div class="stat-number" style="color:#880e4f;"><?php echo e($totalBrideAttending); ?></div>
...
<div class="table-wrapper">
  <table id="rsvp-table">
    ...
    <tbody>
      ...
      <tr data-status="<?php echo e($rsvp->is_attending ? 'attending' : 'not-attending'); ?>" data-type="<?php echo e($rsvp->type == 2 ? 'bride' : 'groom'); ?>">
...
<div class="modal-backdrop" id="import-modal" onclick="if(event.target===this)this.classList.remove('open')">
  <div class="modal-box">
    ...
    <form method="POST" action="<?php echo e(route('admin.rsvp.import')); ?>" enctype="multipart/form-data" onsubmit="return confirmImport()">
      <?php echo csrf_field(); ?>
