...
<div class="stats-bar">
  <div class="stat-card">
    <div class="stat-number"><?php echo e($visits->count()); ?></div>
    <div class="stat-label">Tổng lượt xem</div>
  </div>
  <div class="stat-card groom">
    <div class="stat-number"><?php echo e($visits->where('type', 1)->count()); ?></div>
    <div class="stat-label">Nhà Trai</div>
  </div>
  <div class="stat-card bride">
    <div class="stat-number"><?php echo e($visits->where('type', 2)->count()); ?></div>
    <div class="stat-label">Nhà Gái</div>
  </div>
  <div class="stat-card">
    <div class="stat-number"><?php echo e($visits->whereNotNull('invite_name')->count()); ?></div>
...
<div class="table-wrapper">
  <table id="visits-table">
    ...
    <tbody>
      ...
      <tr data-type="<?php echo e($visit->type == 2 ? 'bride' : 'groom'); ?>" data-named="<?php echo e($visit->invite_name ? 'yes' : 'no'); ?>">
        <td><?php echo e($index + 1); ?></td>
        <td class="td-name"><?php echo e($visit->invite_name ?? 'Khách mời'); ?></td>
        <td>
          <?php if($visit->type == 2): ?>
        ...
        <td class="td-time"><?php echo e($visit->created_at->format('H:i d/m/Y')); ?></td>
        <td>
          <form method="POST" action="<?php echo e(route('admin.visit.delete', $visit)); ?>" onsubmit="return confirm('Xóa lượt xem này?')" style="display:inline;">
            <?php echo csrf_field(); ?>
            <?php echo method_field('DELETE'); ?>
...
<?php /**PATH C:\Users\thispc\Documents\wedding-site\resources\views/admin/visits.blade.php ENDPATH**/ ?>