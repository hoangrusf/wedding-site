            ...
            <td style="padding:32px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                <tr>
                  ...
                  <td style="padding:10px 0;border-bottom:1px solid #f0e4e8;color:#333;font-size:14px;font-weight:600;"><?php echo e($rsvpData['guest_name']); ?></td>
                </tr>
                <?php if(!empty($rsvpData['phone_number'])): ?>
                <tr>
                  <td style="padding:10px 0;border-bottom:1px solid #f0e4e8;color:#888;font-size:13px;">Số điện thoại</td>
                  <td style="padding:10px 0;border-bottom:1px solid #f0e4e8;color:#333;font-size:14px;"><?php echo e($rsvpData['phone_number']); ?></td>
                </tr>
                <?php endif; ?>
                <?php if($rsvpData['is_attending']): ?>
                <tr>
                  ...
                  <td style="padding:10px 0;border-bottom:1px solid #f0e4e8;color:#333;font-size:14px;">
                    <?php echo e($rsvpData['companion_count'] == 0 ? 'Chỉ mình tôi' : $rsvpData['companion_count'] . ' người'); ?>
                ...
                <tr>
                  ...
                  <td style="padding:10px 0;border-bottom:1px solid #f0e4e8;color:#c9667a;font-size:14px;font-weight:700;">
                    <?php echo e(1 + ($rsvpData['companion_count'] ?? 0)); ?> người
                  </td>
                </tr>
                <?php endif; ?>
                <tr>
                  <td style="padding:10px 0;color:#888;font-size:13px;">Thời gian gửi</td>
                  <td style="padding:10px 0;color:#333;font-size:14px;"><?php echo e(now()->setTimezone('Asia/Ho_Chi_Minh')->format('H:i - d/m/Y')); ?></td>
                </tr>
              </table>

              <!-- Wishes -->
              <?php if(!empty($rsvpData['wishes_message'])): ?>
              <div style="margin-top:24px;background:#fdf5f7;border-left:3px solid #c9667a;border-radius:0 8px 8px 0;padding:16px 20px;">
                ...
                <p style="margin:0;color:#333;font-size:14px;line-height:1.6;font-style:italic;">"<?php echo e($rsvpData['wishes_message']); ?>"</p>
              </div>
              <?php endif; ?>
...
<?php /**PATH C:\Users\thispc\Documents\wedding-site\resources\views/mail/rsvp-notification.blade.php ENDPATH**/ ?>