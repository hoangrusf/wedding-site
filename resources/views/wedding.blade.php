...
<body>
  ...
  <main id="main-content" class="main-content hidden">
      ...
      <div class="event-timeline" data-aos="fade-up" data-aos-delay="200">
        <div class="timeline-item">
          ...
          <div class="timeline-content">
            <h4>Đón Khách</h4>
            <p class="timeline-time">{{ $config->wedding_date->copy()->subMinutes(30)->format('H:i') }}</p>
          </div>
        </div>
        <div class="timeline-item">
          <div class="timeline-icon">
          ...
          <div class="timeline-content">
            <h4>Làm Lễ</h4>
            <p class="timeline-time">{{ $config->wedding_date->format('H:i') }}</p>
          </div>
        </div>
        <div class="timeline-item">
          <div class="timeline-icon">
          ...
          <div class="timeline-content">
            <h4>Khai Tiệc</h4>
            <p class="timeline-time">{{ $config->wedding_date->copy()->addHour()->format('H:i') }}</p>
          </div>
        </div>
      </div>
    ...
    <footer class="footer" data-aos="fade-up">
      ...
      <p class="footer-names">{{ $config->groom_name }} ♡ {{ $config->bride_name }}</p>
